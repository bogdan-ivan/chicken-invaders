...
NeutronGun::NeutronGun(std::vector<Projectile>& projectiles, sf::VideoMode& vm)
	:Weapon(projectiles, vm)
{

}

NeutronGun::~NeutronGun()
{

}

void NeutronGun::shoot(uint16_t firePower, sf::Vector2f position, float playerHeight)
{
